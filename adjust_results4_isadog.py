...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for i in results_dic:
        ...
        if(results_dic[i][0] in dognames_dic.keys()):
        ...
        if(results_dic[i][1] in dognames_dic.keys()):
            results_dic[i].append(1)
        else:
            results_dic[i].append(0)
     
   # print("Printing dogs below")
    #print(v)
    #print("Printing dognames dic")
    #print(dognames_dic)
    #print(results_dic)
    None
